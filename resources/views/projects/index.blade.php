                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap text-[11px] leading-4 font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button @click="$dispatch('open-delete-modal', { project: {{ json_encode($project) }} })" class="text-red-600 hover:text-red-800 p-1 rounded hover:bg-red-50 transition-all duration-200 transform hover:scale-110 cursor-pointer" title="Hapus">
