                    ...
                    <div class="space-y-2">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="flex space-x-1">
                                ...
                                <a href="{{ route('projects.edit', $project) }}" class="text-yellow-600 hover:text-yellow-800 p-1 rounded hover:bg-yellow-50" title="Edit">
                                    <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 whitespace-nowrap text-[11px] leading-4 font-medium">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('projects.edit', $project) }}" class="text-yellow-600 hover:text-yellow-800" title="Edit">
