...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">Masukkan informasi proyek website baru</p>
    </div>
        ...
        <form action="{{ route('projects.store') }}" method="POST" class="space-y-6 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" name="domain_expiry" id="domain_expiry" value="{{ old('domain_expiry') }}"
                ...
                <div>
                    ...
                    <input type="date" name="hosting_expiry" id="hosting_expiry" value="{{ old('hosting_expiry') }}"
                ...
                <div>
                    <label for="hosting_provider" class="block text-sm font-medium text-gray-700">Provider Hosting</label>
                    <select name="hosting_provider" id="hosting_provider"
                        ...
                        <option value="Shared Hosting" {{ old('hosting_provider') == 'Shared Hosting' ? 'selected' : '' }}>Shared Hosting</option>
                        <option value="Cloud Server" {{ old('hosting_provider') == 'Cloud Server' ? 'selected' : '' }}>Cloud Server</option>
                        <option value="VPS Server" {{ old('hosting_provider') == 'VPS Server' ? 'selected' : '' }}>VPS Server</option>
                    </select>
            ...
            <div>
                ...
                <select name="package_status" id="package_status" required
                    ...
                    <option value="website" {{ old('package_status') == 'website' ? 'selected' : '' }}>Pembuatan Website</option>
                    <option value="maintenance" {{ old('package_status') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
                    <option value="seo" {{ old('package_status') == 'seo' ? 'selected' : '' }}>SEO</option>
                    <option value="website_maintenance" {{ old('package_status') == 'website_maintenance' ? 'selected' : '' }}>Pembuatan Website, Maintenance</option>
                    <option value="website_seo" {{ old('package_status') == 'website_seo' ? 'selected' : '' }}>Pembuatan Website, SEO</option>
                    <option value="website_maintenance_seo" {{ old('package_status') == 'website_maintenance_seo' ? 'selected' : '' }}>Pembuatan Website, Maintenance, SEO</option>
                </select>
            ...
            <div class="flex justify-end space-x-3">
                <a href="{{ route('projects.index') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                    Batal
                </a>
